...
class FundScreen(Screen):
    ...
    def Submit_Fund(self):
        ...
        sql_string11 = "insert into icp.Fund(Daily_Chrg,Loading_fee,Facility_fee) values({0},{1},{2});".format(
            self.ids.Daily_Chrg_textf.text.strip(), self.ids.Loading_fee_textf.text.strip(), self.ids.Facility_fee_textf.text.strip())
